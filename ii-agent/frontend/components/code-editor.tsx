...
const ROOT_NAME = brandingConfig.filesystem.rootFolderName;
...
const CodeEditor = ({
  ...
  return (
    <div
      className={`flex flex-col h-[calc(100vh-178px)] rounded-xl border border-border shadow-sm overflow-hidden ${className}`}
    >
