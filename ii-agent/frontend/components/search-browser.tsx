...
const SearchBrowser = ({
  ...
  return (
    <div
      className={`h-[calc(100vh-178px)] flex rounded-xl flex-col overflow-hidden border border-border ${className}`}
    >
      <div className="flex items-center gap-3 px-3 py-2.5 bg-black/80 backdrop-blur-xl border-b border-neutral-800">
        ...
        <div className="flex-1 flex items-center">
          <div className="bg-secondary px-3 py-1.5 rounded-lg w-full flex items-center gap-2 group transition-colors">
            <SearchIcon className="h-3.5 w-3.5 text-foreground flex-shrink-0" />
