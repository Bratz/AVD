  ...
  return (
    ...
    >
      ...
      >
            ...
            {files.map((file) => {
              ...
              if (file.isFolder) {
                return (
                  <div
                    key={file.name}
                    className="flex items-center gap-2 bg-card text-card-foreground rounded-full px-3 py-2 border border-border shadow-sm"
                  >
              ...
              return (
                <div
                  key={file.name}
                  className="flex items-center gap-2 bg-neutral-900 text-foreground rounded-full px-3 py-2 border border-gray-700 shadow-sm"
                >
                  <div
        ...
        <Textarea
          className={`w-full p-4 pb-[72px] rounded-xl !text-lg focus:ring-0 resize-none !placeholder-gray-400 !bg-secondary border-[#ffffff0f] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.02)] ${
          ...
          ref={textareaRef}
        />
        <div className="flex justify-between items-center absolute bottom-0 py-4 m-px w-[calc(100%-4px)] rounded-b-xl bg-secondary px-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="hover:bg-muted/50 size-10 rounded-full cursor-pointer border border-border shadow-sm"
                  disabled={
                    state.isUploading ||
                    state.isLoading ||
                    isDisabled ||
              ...
              >
                <DropdownMenuItem
                  className="flex p-2 items-center gap-2 cursor-pointer hover:bg-muted"
                ...
                >
                  {state.isGeneratingPrompt ? (
                    ...
                    <Image
                      ...
                      width={24}
                      height={24}
                      style={{ width: '24px', height: 'auto' }} // Add this
                    />
                  )}
                </Button>
              </TooltipTrigger>
